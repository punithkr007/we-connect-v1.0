...
<spring:url value="/Resources/font-awesome/css/font-awesome.css"
	var="fontAwesome" />
<spring:url value="/Resources/css/plugins/toastr/toastr.min.css"
	var="toasterMinCss" />
<spring:url value="/Resources/js/plugins/gritter/jquery.gritter.css"
	var="gritterCss" />
<spring:url value="/Resources/css/animate.css" var="animateCss" />
<spring:url value="/Resources/css/style.css" var="styleCss" />

<spring:url value="/Resources/img/" var="images"></spring:url>

<link href="${bootstrapCss}" rel="stylesheet" />
<link href="${fontAwesome}" rel="stylesheet" />
<link href="${toasterMinCss}" rel="stylesheet" />
				...
				<ul class="nav metismenu" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span> <img alt="image" class="img-circle" height="80px" width="100px"
								src="${images}/Punith.JPG" />
							</span> <a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<span class="clear"> <span class="block m-t-xs"> <strong
										class="font-bold">Punith KR</strong>
					...
					<li><a href="#"><i class="fa fa-sitemap"></i> <span
						...
						<ul class="nav nav-second-level collapse">
							<li><a href="#" id="damian">Third Level <span
                        ...
                        <div class="social-feed-box">
                            ...
                            <div class="social-avatar">
                                <a href="" class="pull-left">
                                    <img alt="image" src="${images}/Ravi.jpg">
                                </a>
                                <div class="media-body">
                                    <a href="#">
                                        Ravi VH
                            ...
                            <div class="social-footer">
                                <div class="social-comment">
                                    <a href="" class="pull-left">
                                        <img alt="image" src="http://www.idlebrain.com/movie/photogallery/dishapatani3/images/th_dishapatani1.jpg">
                                    </a>
                                    <div class="media-body">
                                        <a href="#">
                                            Srathi Joshi
...
<!-- ENDS -->
	...
	<spring:url value="/Resources/js/plugins/metisMenu/jquery.metisMenu.js" var="jQueryMentiMenuJs" />
	<spring:url value="/Resources/js/plugins/slimscroll/jquery.slimscroll.min.js" var="jQuerySlimScrollJs" />
	<spring:url value="/Resources/js/plugins/flot/jquery.flot.js" var="jQueryFlotJs" />
	<spring:url value="/Resources/js/plugins/flot/jquery.flot.tooltip.min.js" var="jQueryFlotToolTipJs" />
	<spring:url value="/Resources/js/plugins/flot/jquery.flot.spline.js" var="jQueryFlotSplineJs" />
	<spring:url value="/js/plugins/flot/jquery.flot.resize.js" var="jQueryFlotResizeJs" />
	<spring:url value="/Resources/js/plugins/flot/jquery.flot.pie.js" var="jQueryFlotPieJs" />
	<spring:url value="/Resources/js/plugins/peity/jquery.peity.min.js" var="jQueryPeityJs" />
	...
	<spring:url value="/Resources/js/plugins/gritter/jquery.gritter.min.js" var="jQueryGritterJs" />
	<spring:url value="/js/plugins/sparkline/jquery.sparkline.min.js" var="jQuerySparklineJs" />
	<spring:url value="/Resources/js/demo/sparkline-demo.js" var="sparkLineDemoJs" />
	<spring:url value="/Resources/js/plugins/chartJs/Chart.min.js" var="chartJs" />
	<spring:url value="/Resources/js/plugins/toastr/toastr.min.js" var="toasterJS" />

	<script  src="${jQueryJs}"></script>
	<script  src="${bootstrapJs}"></script>
	<script  src="${jQueryMentiMenuJs}"></script>
	...
	<script  src="${jQueryPeityJs}"></script>
	...
	<script  src="${sparkLineDemoJs}"></script>
	<script  src="${chartJs}"></script>
	<script  src="${toasterJS}"></script>
